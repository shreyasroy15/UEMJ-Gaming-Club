...
const Dashboard = () => {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-300">
      ...
      {/* ========================================================================= */}
      <div className="admin-gradient-card rounded-[2rem] p-6 sm:p-8 admin-shadow-card border border-slate-200 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-2 text-sky-600 font-bold text-[10px] tracking-widest uppercase mb-4 font-mono">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-slate-800 mb-4 sm:mb-6 flex flex-wrap items-center gap-3 sm:gap-4 tracking-tight">
            <span>UEMJ</span>
            <span className="admin-gradient-primary text-white px-4 sm:px-5 py-1 sm:py-1.5 rounded-xl admin-shadow-card transform -rotate-1 inline-block border border-slate-700 border-b-2 border-b-slate-900 admin-shadow-inner-glow text-xl sm:text-2xl md:text-3xl">
              ADMIN DASHBOARD
            </span>
          </h2>

          <p className="text-slate-500 text-sm sm:text-base md:text-lg max-w-3xl mb-6 sm:mb-8 leading-relaxed font-medium">
          ...
          <div className="flex flex-wrap gap-3 sm:gap-4">
            <Link
              to="/admin/matches"
              className="bg-white border border-slate-200 hover:border-sky-300 hover:bg-sky-50 text-slate-700 font-bold rounded-xl px-5 sm:px-6 py-2.5 sm:py-3 flex items-center gap-2 transition-all shadow-sm text-xs sm:text-sm cursor-pointer"
            >
            ...
            <Link
              to="/admin/matches"
              className="admin-gradient-accent hover:opacity-90 text-white font-bold rounded-xl px-5 sm:px-6 py-2.5 sm:py-3 admin-shadow-glow-accent transition-all hover:-translate-y-0.5 flex items-center gap-2 border border-blue-400/30 text-xs sm:text-sm cursor-pointer shadow-sm"
            >
            ...
            <button
              ...
              className="bg-white border border-slate-200 hover:border-slate-300 text-slate-500 hover:text-slate-800 p-2.5 sm:p-3 rounded-xl shadow-sm transition-all cursor-pointer"
            >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        ...
        <div className="bg-white rounded-2xl p-6 admin-shadow-card border border-slate-100 flex flex-col justify-between admin-card-hover-effect relative overflow-hidden group">
          ...
          <div className="flex justify-between items-start mb-4">
            ...
            <div className="w-10 h-10 rounded-xl bg-sky-50 text-sky-500 border border-sky-100 flex items-center justify-center shadow-sm">
          ...
          <div>
            <div className="flex items-baseline gap-3">
              ...
              <span className="bg-emerald-50 text-emerald-600 border border-emerald-100 text-[10px] font-bold px-2 py-0.5 rounded-md flex items-center gap-1 shadow-sm">
                <span className="text-[10px]">↑</span> 14%
              </span>
            </div>
            <p className="text-xs text-slate-500 mt-2 font-medium">Verified campus gamers registered</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-6 admin-shadow-card border border-slate-100 flex flex-col justify-between admin-card-hover-effect relative overflow-hidden group">
          ...
          <div className="flex justify-between items-start mb-4">
            ...
            <div className="w-10 h-10 rounded-xl bg-indigo-50 text-indigo-500 border border-indigo-100 flex items-center justify-center shadow-sm">
          ...
          <div>
            <div className="flex items-baseline gap-3">
              ...
              <span className="bg-amber-50 text-amber-600 border border-amber-100 text-[10px] font-bold px-2 py-0.5 rounded-md shadow-sm">
                {stats?.pendingTeams ? `${stats.pendingTeams} Pending` : 'Verified'}
              </span>
            </div>
            <p className="text-xs text-slate-500 mt-2 font-medium">BGMI, FreeFire & Valorant rosters</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-6 admin-shadow-card border border-slate-100 flex flex-col justify-between admin-card-hover-effect relative overflow-hidden group">
          ...
          <div className="flex justify-between items-start mb-4">
            ...
            <div className="w-10 h-10 rounded-xl bg-emerald-50 text-emerald-500 border border-emerald-100 flex items-center justify-center shadow-sm">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 mt-2 font-medium">In-progress arenas right now</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-6 admin-shadow-card border border-slate-100 flex flex-col justify-between admin-card-hover-effect relative overflow-hidden group">
          ...
          <div className="flex justify-between items-start mb-4">
            ...
            <div className="w-10 h-10 rounded-xl bg-rose-50 text-rose-500 border border-rose-100 flex items-center justify-center shadow-sm">
          ...
          <div>
            <div className="flex items-baseline gap-3">
              ...
              <span className="bg-rose-50 text-rose-600 border border-rose-100 text-[10px] font-bold px-2 py-0.5 rounded-md shadow-sm">
                Open
              </span>
            </div>
            <p className="text-xs text-slate-500 mt-2 font-medium">Active registration phase</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-2xl p-6 admin-shadow-card border border-slate-200/80 flex flex-col relative overflow-hidden">
          ...
          <div className="space-y-3.5 overflow-y-auto pr-1 admin-scrollbar" style={{ maxHeight: '400px' }}>
              ...
              recentTournaments.map((t) => {
                ...
                return (
                  <Link
                    ...
                    key={t._id}
                    className="block bg-slate-50 hover:bg-sky-50/50 border border-slate-200 rounded-xl p-4 hover:border-sky-300 transition-all group relative overflow-hidden"
                  >
                    <div className="absolute left-0 top-0 bottom-0 w-1 admin-gradient-accent"></div>
                    <div className="flex justify-between items-start mb-2 pl-2">
                      <h4 className="font-bold text-slate-800 text-sm group-hover:text-sky-600 transition-colors truncate">
                        {t.name}
                      </h4>
                      <span className="bg-slate-800 text-white text-[9px] font-bold px-2 py-0.5 rounded uppercase tracking-wider shadow-sm shrink-0 ml-2">
                        {t.status === 'live' ? 'LIVE NOW' : 'Reg Open'}
                      </span>
                    </div>

                    <div className="text-xs text-slate-500 font-medium mb-3 pl-2">
                    ...
                    <div className="flex items-center justify-between pl-2 pt-2.5 border-t border-slate-200">
                      ...
                      <span className="text-sm font-black text-amber-500 tracking-tight font-mono">
          ...
          <div className="space-y-2 overflow-y-auto pr-1 admin-scrollbar" style={{ maxHeight: '400px' }}>
            {teamsLeaderboard.length === 0 ? (
              ...
              teamsLeaderboard.map((team, idx) => (
                <div
                  key={team._id || idx}
                  className="flex items-center justify-between p-3 rounded-xl hover:bg-slate-50 transition-colors border border-slate-100 hover:border-slate-200 group"
                >
                  <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="w-9 h-9 admin-gradient-primary rounded-lg flex items-center justify-center text-white text-xs admin-shadow-inner-glow border border-slate-700 shrink-0">
                  ...
                  <span className="bg-emerald-50 text-emerald-600 border border-emerald-100 text-[9px] font-bold px-2 py-1 rounded-md flex items-center gap-1 shadow-xs uppercase tracking-wider shrink-0 ml-2">
            ...
            {recentUsers.length === 0 ? (
              ...
              recentUsers.map((player, idx) => {
                ...
                return (
                  <div
                    key={player._id || idx}
                    className="flex items-center justify-between p-3 rounded-xl hover:bg-slate-50 transition-colors border border-slate-100 hover:border-slate-200"
                  >
                    <div className="flex items-center gap-3 min-w-0">
                      <div
                        className={`w-9 h-9 rounded-lg flex items-center justify-center font-bold text-sm border shadow-xs shrink-0 ${colorClass}`}
                      >
                        {initials}
                      </div>
                      <div className="truncate">
                    ...
                    <span className="bg-slate-100 text-slate-600 text-[9px] font-bold px-2 py-1 rounded border border-slate-200 shadow-xs uppercase tracking-wider shrink-0 ml-2 font-mono">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 pb-8">
        ...
        <div className="lg:col-span-2 bg-white rounded-2xl p-6 admin-shadow-card border border-slate-200/80 space-y-4">
        ...
        <div className="bg-white rounded-2xl p-6 admin-shadow-card border border-slate-200/80 space-y-4">
          ...
          <div className="space-y-2.5 text-xs">
            <div className="p-3 rounded-xl bg-slate-50 border border-slate-100 flex items-center justify-between">
              <span className="text-slate-500 font-medium">Server Node</span>
              <span className="text-emerald-600 font-bold font-mono">ONLINE (:5000)</span>
            </div>

            <div className="p-3 rounded-xl bg-slate-50 border border-slate-100 flex items-center justify-between">
              <span className="text-slate-500 font-medium">Database Cluster</span>
              <span className="text-sky-600 font-bold font-mono">MongoDB Atlas Connected</span>
            </div>

            <div className="p-3 rounded-xl bg-slate-50 border border-slate-100 flex items-center justify-between">
              <span className="text-slate-500 font-medium">Scoring Engine</span>
              <span className="text-indigo-600 font-bold font-mono">BGIS / FFWS Active</span>
            </div>

            <div className="p-3 rounded-xl bg-slate-50 border border-slate-100 flex items-center justify-between">
              <span className="text-slate-500 font-medium">Active Tournament</span>
              <span className="text-slate-800 font-bold">TechFest BGMI 2024</span>
            </div>
          </div>
        </div>
      </div>
