        ...
        {toasts.map((toast) => (
          <div
            ...
            className={`pointer-events-auto flex items-start gap-3 p-4 rounded-xl border backdrop-blur-xl shadow-2xl transition-all duration-300 transform translate-y-0 ${
              toast.type === 'success'
                ? 'bg-emerald-950/80 border-emerald-500/50 text-emerald-100 shadow-emerald-900/20'
                : toast.type === 'error'
                ? 'bg-rose-950/80 border-rose-500/50 text-rose-100 shadow-rose-900/20'
                : 'bg-slate-900/90 border-cyan-500/40 text-cyan-100 shadow-cyan-900/20'
            }`}
          >
